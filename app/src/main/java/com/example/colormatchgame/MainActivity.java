...
public class MainActivity extends AppCompatActivity {
    ...
    private void setArrowImage (int state) {
        switch (state) {
            case Blue:
                color_arrow.setImageResource(R.drawable.arrow_blue);
                arrowState = Blue;
                break;

            case Red:
                color_arrow.setImageResource(R.drawable.arrow_red);
                arrowState = Red;
                break;

            case Green:
                color_arrow.setImageResource(R.drawable.arrow_green);
                arrowState = Green;
                break;

            case Orange:
                color_arrow.setImageResource(R.drawable.arrow_orange);
                arrowState = Orange;
                break;
    ...
    private  void setButtonImage (int state){
        switch (state) {
            case Blue:
                setRotation(color_button, R.drawable.color_blue);
                buttonState = Blue;
                break;

            case Red:
                setRotation(color_button, R.drawable.color_red);
                buttonState = Red;
                break;

            case Green:
                setRotation(color_button, R.drawable.color_green);
                buttonState = Green;
                break;

            case Orange:
                setRotation(color_button, R.drawable.color_orange);
                buttonState = Orange;
                break;
